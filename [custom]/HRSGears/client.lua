...
RegisterCommand('shiftalert', function()
    ...
    if beepSoundEnabled then
        ...
        TriggerEvent('np-notify:sendNotify', 'Shift alert sound enabled', 1)
    else
        --[[TriggerEvent('chat:addMessage', {
            color = { 255, 0, 0},
            multiline = true,
        ...
        TriggerEvent('np-notify:sendNotify', 'Shift alert sound disabled', 2)
    end
end, false)
...
exports('GetGear', getSelectedGear)