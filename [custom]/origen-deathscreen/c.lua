local isDead = false
RegisterNetEvent('origen-deathscreen:openUI', function(time)
    isDead = true
...
RegisterNetEvent('origen-deathscreen:revive', function()
    isDead = false
...
RegisterNetEvent('origen-deathscreen:die', function(time)
    isDead = true
    SendNUIMessage({action = "DSMenu", open = true, time = time})
    if Config.Blur then
        TriggerScreenblurFadeIn()
...
RegisterNetEvent('origen-deathscreen:res', function()
    SendNUIMessage({action = "res"})
end)

RegisterNetEvent('origen-deathscreen:updateRes', function(time)
