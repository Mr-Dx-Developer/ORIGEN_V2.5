...
Config.Shops = {
    {
        ...
        categories = {
            [1] = {
                ...
                description = "24/7",
                items = {
                    {name = "water_bottle", label = "Water", perPrice = 150, description = "Drinks", requiredLicense = {'driver'}},
                    {name = "sandwich", label = "Sandwich", perPrice = 150, description = "Food", requiredLicense = {'driver'}},
                    {name = "snikkel_candy", label = "Snikkel Candy", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                    {name = "tosti", label = "Tosti", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                    {name = "beer", label = "Beer", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                    {name = "cola", label = "Cola", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                    {name = "twerks_candy", label = "Twerks Candy", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                    {name = "whiskey", label = "Whiskey", perPrice = 150, description = "General", requiredLicense = {'driver'}},
                }                
            },
        },
