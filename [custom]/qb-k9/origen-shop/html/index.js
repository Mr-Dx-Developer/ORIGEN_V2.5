...
window.addEventListener('message', function(event) {
    ...
    if (ed.action === "openShop") {
        ...
        ed.basket.forEach(function(data, index) {
            ...
            <div class="cart-item">
                <div class="cart-img">
                <img src="nui://qb-inventory/html/images/${data.name}.png" alt="">
                </div>
    ...
    if (name1 === "shopItems") {
        ...
        cData[name2].forEach(function(data, index) {
            ...
            <div class="item">
                ...
                <img class="img" src="nui://qb-inventory/html/images/${data.name}.png" alt="">
                <div class="itemalt">
                    <div class="item-name">${data.label}</div>
                    <div class="item-altcategory">${data.description}</div>
                    <div class="cartbox" onclick="clFunc('addBasket', '${data.name}', '${data.perPrice}', '${data.label}')">
        ...
        cData[name2].forEach(function(data, index) {
            ...
            <div class="job-item">
                ...
                <img class="job-img" src="nui://qb-inventory/html/images/${data.name}.png" alt="">
