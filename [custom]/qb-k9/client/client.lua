...
CreateThread(function()
  exports['qb-target']:AddBoxZone("1234", vector3(447.26, -1000.21, 30.15), 1.5, 1.6, {
    name = "1234", 
    heading = 102.0, 
    debugPoly = false, 
    minZ = 25.7, 
...
RegisterNetEvent("elixir-k9:Follow")
AddEventHandler("elixir-k9:Follow", function()
ExecuteCommand('cannineattackfollow')
end)

RegisterNetEvent("elixir-k9:Sit")
AddEventHandler("elixir-k9:Sit", function()
  PlayAnimation(sit.dict, sit.anim)
end)

RegisterNetEvent("elixir-k9:EnterVeh")
AddEventHandler("elixir-k9:EnterVeh", function()
  K9ToggleVehicle(false)
end)

RegisterNetEvent("elixir-k9:laydown")
AddEventHandler("elixir-k9:laydown", function()
  PlayAnimation(laydown.dict, laydown.anim)
end)

RegisterNetEvent("elixir-k9:searchcar")
AddEventHandler("elixir-k9:searchcar", function()
  K9SearchVehicle()
end)

RegisterNetEvent("elixir-k9:searchdude")
AddEventHandler("elixir-k9:searchdude", function()
  K9SearchPerson()
end)

RegisterNetEvent("elixir-k9:searcharea")
AddEventHandler("elixir-k9:searcharea", function()
  K9SearchArea()
end)
