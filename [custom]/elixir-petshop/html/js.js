...
$(".close-button").click(function () {
  $(".bg").css("display", "none");
  $('#kutucuk').empty();
	$.post('http://elixir-petshop/closenui', JSON.stringify({}));
});
...
function pew(id) { 
  ...
  $('#kutucuk').empty();
	$.post('http://elixir-petshop/showpet', JSON.stringify({id:id}));
}
...
$(".buy-button").click(function () {
  ...
  $(".bg-3").css("display", "none");
	$.post('http://elixir-petshop/closenui', JSON.stringify({}));
	$.post('http://elixir-petshop/cam', JSON.stringify({}));
	$.post('http://elixir-petshop/buy', JSON.stringify({}));
});
...
function spawnpet() {
	$.post('http://elixir-petshop/spawnpet', JSON.stringify({}));
}

function vehicle() {
	$.post('http://elixir-petshop/vehicle', JSON.stringify({}));
}

function sit() {
	$.post('http://elixir-petshop/sit', JSON.stringify({}));
}

function sleep() {
	$.post('http://elixir-petshop/sleep', JSON.stringify({}));
}

function box1() { 
	$.post('http://elixir-petshop/box-menu', JSON.stringify({}));
  $(".bg").css("display", "none");
  $('#kutucuk').empty();
...
function box2() { 
	$.post('http://elixir-petshop/box-menu2', JSON.stringify({}));
  $(".bg").css("display", "none");
  $('#kutucuk').empty();
  $(".bg-2").css("display", "block");
}
...
function deletela() { 
  $(".bg-4").css("display", "none");
	$.post('http://elixir-petshop/delete', JSON.stringify({}));
}