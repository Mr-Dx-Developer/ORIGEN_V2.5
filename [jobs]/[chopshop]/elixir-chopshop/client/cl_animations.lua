RegisterNetEvent('elixir-chopshop:wheelanimation')
AddEventHandler('elixir-chopshop:wheelanimation', function()
...
RegisterNetEvent('elixir-chopshop:dooranimation')
AddEventHandler('elixir-chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('elixir-chopshop:trunkanimation')
AddEventHandler('elixir-chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('elixir-chopshop:hoodanimation')
AddEventHandler('elixir-chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('elixir-chopshop:wheelchopanim')
AddEventHandler('elixir-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	...
	exports["origen-emotes"]:EmoteCommandStart("weld")
	Citizen.Wait(12000)
	ClearPedTasks(ped)
...
RegisterNetEvent('elixir-chopshop:doorchopanim')
AddEventHandler('elixir-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('elixir-chopshop:hoodchopanim')
AddEventHandler('elixir-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('elixir-chopshop:trunkchopanim')
AddEventHandler('elixir-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
