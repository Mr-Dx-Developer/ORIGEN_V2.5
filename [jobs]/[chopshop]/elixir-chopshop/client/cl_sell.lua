...
RegisterNetEvent('elixir-chopshop:selljod')
AddEventHandler('elixir-chopshop:selljod', function()
SetNewWaypoint(1219.56, 1905.86)
QBCore.Functions.Notify('A Location has been set in your gps.', 'info', 4500)
end)