...
CreateThread(function()
    exports['qb-target']:AddTargetModel(Config.BossPed, {
        options = {
            { 
				type = "client",
				event = "elixir-weedrun:client:checkitem",
				icon = "fas fa-circle",
            ...
            { 
                type = "client", 
				event = "elixir-weedrun:client:packagegoods",
				icon = "fas fa-box",
...
RegisterNetEvent('elixir-weedrun:client:checkitem')
AddEventHandler('elixir-weedrun:client:checkitem', function()
    QBCore.Functions.TriggerCallback('QBCore:HasItem', function(hasItem)
        if hasItem then
            TriggerEvent('elixir-weedrun:client:start')
        else
...
RegisterNetEvent('elixir-weedrun:client:start', function ()
    QBCore.Functions.TriggerCallback("elixir-weedrun:server:getCops", function(enoughCops)
        if enoughCops >= Config.MinimumPolice then
            QBCore.Functions.TriggerCallback("elixir-weedrun:server:coolc",function(isCooldown)
                if not isCooldown then
                    ...
                    QBCore.Functions.Progressbar("search_register", Lang:t("progress.preparing_run"), 5000, false, true, {
                        ...
                        TriggerServerEvent('elixir-weedrun:server:startr')
                    end, function() -- Cancel
...
RegisterNetEvent('elixir-weedrun:client:signoff', function()
	...
	exports['qb-target']:AddTargetModel(Config.BossPed, {
		options = {
			{
				type = "client",
				event = "elixir-weedrun:client:endRun",
				icon = "fas fa-circle",
...
RegisterNetEvent('elixir-weedrun:signin', function()
	exports['qb-target']:RemoveTargetModel(Config.BossPed, {
	...
	exports['qb-target']:AddTargetModel(Config.BossPed, {
		options = {
			{
				type = "client",
				event = "elixir-weedrun:client:endRun2",
				icon = "fas fa-circle",
...
RegisterNetEvent('elixir-weedrun:client:endRun2', function()  
	ClearAllBlipRoutes()
...
RegisterNetEvent('elixir-weedrun:client:endRun', function()  
	ClearAllBlipRoutes()
	...
	TriggerServerEvent('elixir-weedrun:server:signoff')
...
RegisterNetEvent('elixir-weedrun:client:nextdelivery', function()
	ClearAllBlipRoutes()
	for _,v in pairs(bliptable) do
		RemoveBlip(v)
	end
...
RegisterNetEvent('weed-generate-sell-loc', function()
	...
	exports['qb-target']:AddTargetModel({name}, {
		options = {
			{
				event = "elixir-weedrun:client:deliverPackage",
...
RegisterNetEvent('elixir-weedrun:client:packagegoods', function()
	QBCore.Functions.TriggerCallback("elixir-weedrun:ItemCheck", function(result)
		if result then
			exports['qb-target']:RemoveTargetModel(Config.BossPed, {
...
RegisterNetEvent('collect-weed', function()
	...
	TriggerServerEvent('elixir-weedrun:server:packagereward')

end)


RegisterNetEvent('elixir-weedrun:client:removetarget', function()
	exports['qb-target']:RemoveTargetModel(Config.BossPed, {
		Lang:t("target.collect_goods"),
	})
end)

RegisterNetEvent('elixir-weedrun:client:checkPackage', function()
Wait(23000)
delievered = true
end)

RegisterNetEvent("elixir-weedrun:client:deliverPackage")
AddEventHandler("elixir-weedrun:client:deliverPackage", function()
	if holdingBox then
		...
		TriggerEvent('elixir-weedrun:client:checkPackage')
...
RegisterNetEvent("elixir-weedrun:client:hasPackage")
AddEventHandler("elixir-weedrun:client:hasPackage", function()
	local ped = PlayerPedId()

	QBCore.Functions.TriggerCallback('elixir-weedrun:server:hasPackage', function(hasItems)
		if hasItems then
...
RegisterNetEvent('elixir-weedrun:client:email', function() 
