...
Config = {
    ...
    --CITYHALL JOB--
    ----------------
    NeedJob = false,                          -- Change this to "false" if you do not require players to have the "Technician" job

    -------------
    --MZ-SKILLS--
    -------------
    mzskills = false,                        -- Change to "false" to run the resource without reference to mz-skills    
