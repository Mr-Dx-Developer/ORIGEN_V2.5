...
Citizen.CreateThread(function()
  exports["karma-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('karma-propattach:attach')
AddEventHandler('karma-propattach:attach', function(pPropItem, pTargetFunction)
